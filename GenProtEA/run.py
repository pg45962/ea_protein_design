...
import numpy as np
from loadModels import loadVAE_alt
...
def initializePop():
    ...
    indivList = SeqIO.parse("/home/mmartins/GenProtEA/cov_arvae_samples.fa", "fasta")
    indivList = indivList.seq
    indivList = random.sample(indivList, 100)

    indivList = one_hot_generator(indivList)
...
def savePop(final_pop, fNames, fUsed, totalGenerations):
    ...
    model.G.batch_size = model.batch_size
    print(len(final_pop))
    destFile = "/home/mmartins/GenProtEA/output/VAE_cov_res.csv"
