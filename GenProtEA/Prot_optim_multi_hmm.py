...
from optimization.evaluation import Max_Hidrophobicity, Min_Rules_Solubility, Min_Rules_Synthesis, Prob_Hmm
import sys
...
class caseMinRules_MaxProb(caseStudy):

    def __init__(self):
        super(caseMinRules_MaxProb, self).__init__()
        self.name = "caseMinRules_MaxProb"
    ...
    def objective(self, multiObjective=True):
        ...
        print("\nObjective: HMM paired with PepFUN rules", "Multi-objective")
...
if __name__ == "__main__":
    ...
    caseStud = caseMinRules_MaxProb()
    case = caseStud
    case.run()
    
    #a = caseMaxHydro()
    a = caseMinRules_MaxProb()
    #a.parseResults()
    a.computeMetrics()
    #a.saveResults()    
