...
_, msa_seqs = read_fasta('data/training_data/IPR013765_msa_train.fasta')
_, val_msa_seqs = read_fasta('data/training_data/IPR013765_msa_test.fasta')
...
callbacks=[CSVLogger('output/logs/IPR013765_msa.csv')]
...
if not save_all_epochs:
  model.save_weights('output/weights/IPR013765_msa.h5')
