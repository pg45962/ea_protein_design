...
_, raw_seqs = read_fasta('/home/mmartins/GenProtEA/data/training_data/covab_train.fasta')
_, val_raw_seqs = read_fasta('/home/mmartins/GenProtEA/data/training_data/covab_test.fasta')
...
callbacks=[CSVLogger('/home/mmartins/GenProtEA/output/logs/arvae.csv')]
...
if not save_all_epochs:
  model.save_weights('/home/mmartins/GenProtEA/output/weights/cov_arvae.h5')
